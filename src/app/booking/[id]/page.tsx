  ...
  return (
    <div className='therapy-opt'>
      ...
      <div className=''>
        ...
        <div className="ther-center" style={{ display: 'flex', justifyContent: 'center' }}>
      ...
      <div className='therapy-sel'>
        ...
        <div className="ther-btn-container" style={{ display: 'flex', justifyContent: 'center' }}>
          <Button onClick={() => handleFilter(4)}
            style={{
      ...
      <div className='therapy-center'>
        {filterBtn === 4 && (
          morning.map((timing, index) => (
            <Button
              key={index}
              variant={slot === timing ? "variant" : "outline"}
              style={{
        ...
        {filterBtn === 6 && (
          evening.map((timing, index) => (
            <Button
              key={index}
              variant={slot === timing ? "solid" : "outline"}
              style={{
                borderColor: slot === timing ? '#1F9FE6' : '#C7CDD3',
                color: slot === timing ? 'white' : '#1F9FE6',
                background: slot === timing ? 'black' : '',
